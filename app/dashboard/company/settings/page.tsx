                ...
                <div className="relative z-10 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground/70">{t('settings.manageCompanyPreferences')}</p>
                        </div>
                    </div>
            ...
            <div className="grid gap-6 lg:grid-cols-[240px_1fr]">
                ...
                >
                    <AnimatePresence mode="wait">
                                ...
                                <div className="space-y-6">
                                    <div className="space-y-4">
                                        ...
                                        <SettingToggle
                                            ...
                                            tooltip={t('settings.getNotifiedAboutNewApplications')}
                                        ...
                                        <SettingToggle
                                            ...
                                            description={t('settings.weeklyDigestDescCompany')}
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <SettingToggle
                                            label={t('settings.newApplications')}
                                            description={t('settings.getNotifiedWhenStudentsApply')}
                                            tooltip={t('settings.knowInstantlyWhenSomeoneApplies')}
                                        ...
                                        <SettingToggle
                                            ...
                                            description={t('settings.receiveRemindersForInterviews')}
                        ...
                        {activeTab === "privacy" && (
                            <SettingsSection key="privacy" title={t('settings.privacySettings')} description={t('settings.controlWhoCanSeeCompany')}>
                                <div className="space-y-6">
                                    <div className="space-y-4">
                                        <h3 className="text-sm font-medium flex items-center gap-2 text-foreground/60">
                                            <Eye className="h-4 w-4 text-purple-400" />
                                            {t('settings.companyVisibility')}
                                        </h3>
                                        ...
                                        <RadioGroup 
                                            ...
                                            onValueChange={(v) => {
                                                ...
                                                toast.success(t('settings.visibilityUpdated'), {
                                                    description: t('settings.companyProfileNow', { visibility: v }),
                                                })
                                            }}
                                            className="space-y-3"
                                        >
                                            <Tooltip>
                                                <TooltipTrigger asChild>
                                                    <div className={cn(
                                                        ...
                                                        <Label htmlFor="public" className="flex-1 cursor-pointer">
                                                            ...
                                                            <p className="text-sm text-muted-foreground/60 mt-1">{t('settings.allStudentsCanView')}</p>
                                                        </Label>
                                                        {settings.profileVisibility === "public" && (
                                                ...
                                                <TooltipContent>
                                                    <p>{t('settings.yourCompanyVisibleToAll')}</p>
                                                </TooltipContent>
                                            </Tooltip>
                                            <Tooltip>
                                                <TooltipTrigger asChild>
                                                    <div className={cn(
                                                        ...
                                                        <Label htmlFor="connections" className="flex-1 cursor-pointer">
                                                            <div className="flex items-center gap-2">
                                                                ...
                                                                <span className="font-medium text-foreground/80">{t('settings.applicantsOnly')}</span>
                                                            </div>
                                                            <p className="text-sm text-muted-foreground/60 mt-1">{t('settings.onlyAppliedStudentsCanView')}</p>
                                                        </Label>
                                                        {settings.profileVisibility === "connections" && (
                                                            <Check className="h-5 w-5 text-purple-500" />
                                                        )}
                                                ...
                                                <TooltipContent>
                                                    <p>{t('settings.onlyApplicantsCanSeeDetails')}</p>
                                                </TooltipContent>
                                            </Tooltip>
                                            <Tooltip>
                                                <TooltipTrigger asChild>
                                                    <div className={cn(
                                                        ...
                                                        <Label htmlFor="private" className="flex-1 cursor-pointer">
                                                            ...
                                                            <p className="text-sm text-muted-foreground/60 mt-1">{t('settings.hideFromSearchAndListings')}</p>
                                                        </Label>
                                                        {settings.profileVisibility === "private" && (
                                                            <Check className="h-5 w-5 text-purple-500" />
                                                        )}
                                                ...
                                                <TooltipContent>
                                                    <p>{t('settings.companyHiddenFromEveryone')}</p>
                                                </TooltipContent>
                                            </Tooltip>
                                        </RadioGroup>
                                    </div>
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <SettingToggle
                                            label={t('settings.showActivityStatus')}
                                            description={t('settings.letStudentsSeeActive')}
                                            tooltip={t('settings.displayGreenDotActive')}
                                        ...
                                        <SettingToggle
                                            ...
                                            description={t('settings.allowStudentsDirectMessages')}
                                            tooltip={t('settings.receiveMessagesFromCandidates')}
