...
export function ApplicationsTabContent({ userType }: ApplicationsTabContentProps) {
        ...
        return (
            <div className="space-y-8">
                <div className="relative overflow-hidden">
                    <div
                        className="bg-gradient-to-r from-[var(--application-header-gradient-from)] to-[var(--application-header-gradient-to)] rounded-2xl p-8 mb-8">
    ...
    return (
        <div className="space-y-8">
            <div className="relative overflow-hidden">
                <div
                    className="bg-gradient-to-r from-[var(--application-header-gradient-from)] to-[var(--application-header-gradient-to)] rounded-2xl p-8 shadow-[0_20px_50px_var(--application-shadow-medium)]">
                    <div
                        className="absolute inset-0 bg-gradient-to-r from-violet-600 via-indigo-600 to-blue-600 rounded-3xl"></div>
                                ...
                                <div className="relative flex items-center justify-between">
                                    <div className="flex items-center gap-6">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            {portfolio.headline &&
                                                <p className="text-white/80 text-lg font-medium">{portfolio.headline}</p>}
                                        </div>
                                    </div>
                                    <Button
                                        variant="ghost"
