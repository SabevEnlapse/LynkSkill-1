...
//                             Meet{" "}
//                             <span
//                                 className="bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent">Linky</span>
//                         </h2>
...
//                 <div
//                     className="absolute inset-0 grid grid-cols-[repeat(30,1fr)] grid-rows-[repeat(20,1fr)] gap-0 opacity-40">
//                     {dots.map((dot, index) => (
//                         <motion.div
//                             key={dot.id}
...
//                     <span
//                         className="text-base font-semibold bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent">
...
//                           <span
//                               className="bg-gradient-to-r from-purple-400 via-blue-400 to-purple-400 bg-clip-text text-transparent animate-gradient">
//                             LynkSkill
//                           </span>
//                               <motion.div
...
//                     </h1>
//
//                     <p className="text-xl sm:text-2xl text-muted-foreground max-w-4xl mx-auto leading-relaxed text-balance font-medium">
...
//                             <Button
//                                 size="lg"
//                                 className="group relative overflow-hidden rounded-full px-8 py-6 text-lg font-bold transition-all duration-300 hover:scale-105 active:scale-95 min-w-[240px] bg-gradient-to-r from-purple-600 via-blue-600 to-purple-600 hover:from-purple-500 hover:via-blue-500 hover:to-purple-500 text-white border-0 shadow-2xl shadow-purple-500/50"
//                             >
...
//                             </span>
//                                 <div
//                                     className="absolute inset-0 rounded-full bg-gradient-to-r from-transparent via-white/30 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-700"/>
//                             </Button>
//                         </SignUpButton>
//
...
//                                 size="lg"
//                                 variant="outline"
//                                 className="group relative overflow-hidden rounded-full px-8 py-6 text-lg font-bold transition-all duration-300 hover:scale-105 active:scale-95 min-w-[240px] border-2 border-purple-500/40 hover:border-purple-500/80 bg-background/80 backdrop-blur-md shadow-xl"
//                             >
//                             <span
//                                 className="relative flex items-center gap-3 bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent">
//                               Sign In
//                             </span>
//                             </Button>
//                         </SignInButton>
...
//                     <SignedIn>
//                         <div
//                             className="flex items-center gap-6 px-8 py-4 rounded-full bg-card/50 backdrop-blur-md border-2 border-purple-500/30 shadow-xl">
//                             <UserButton
//                                 appearance={{
//                                     elements: {
//                                         userButtonAvatarBox:
...
//                     <div
//                         className="w-8 h-12 border-2 border-purple-500/40 rounded-full flex items-start justify-center p-2">
//                         <motion.div
...
//                         We&apos;ve built the most comprehensive platform for student-business connections, packed with
//                         features designed
...
//                         How It{" "}
//                         <span
//                             className="bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent">Works</span>
//                     </h2>
//                     <p className="text-xl text-muted-foreground max-w-3xl mx-auto text-balance">
...
//                                 <div
//                                     className="hidden lg:block absolute top-20 left-full w-full h-0.5 bg-gradient-to-r from-purple-500/50 to-blue-500/50 -translate-x-4"/>
//                             )}
//
//                             <div
//                                 className="relative p-8 rounded-3xl bg-card border-2 border-border hover:border-purple-500/50 transition-all duration-300 space-y-6 group hover:shadow-2xl hover:shadow-purple-500/10 h-full flex flex-col"> {/* Added h-full and flex flex-col */}
//                                 {/* Step number */}
//                                 <div className="flex items-center justify-between">
//                                 <span
//                                     className="text-6xl font-bold bg-gradient-to-br from-purple-400 to-blue-400 bg-clip-text text-transparent opacity-50">
//                                     {step.number}
//                                 </span>
//                                     <div
//                                         className="p-3 rounded-xl bg-gradient-to-br from-purple-600 to-blue-600 text-white shadow-lg group-hover:scale-110 transition-transform duration-300">
//                                         {step.icon}
//                                     </div>
//                                 </div>
//
...
//                         >
//                             <div
//                                 className="inline-flex p-4 rounded-2xl bg-gradient-to-br from-purple-600 to-blue-600 text-white shadow-lg group-hover:scale-110 transition-transform duration-300">
//                                 {stat.icon}
//                             </div>
...
//                         What Students{" "}
//                         <span
//                             className="bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent">Say</span>
//                     </h2>
//                     <p className="text-xl text-muted-foreground max-w-3xl mx-auto text-balance">
...
//                                 <div
//                                     className="flex-shrink-0 w-8 h-8 rounded-full bg-gradient-to-br from-purple-600 to-blue-600 flex items-center justify-center text-white font-bold">
...
//                         >
//                             <div
//                                 className={`mt-1 w-1.5 h-1.5 rounded-full bg-gradient-to-r ${gradient} flex-shrink-0`}/>
...
//                     <Button
//                         variant="outline"
//                         className={`group mt-4 border-2 hover:border-transparent bg-gradient-to-r ${gradient} bg-clip-text text-transparent hover:bg-gradient-to-r hover:${gradient} transition-all duration-300`}
//                     >
//                         <span className="flex items-center justify-center gap-0 group-hover:gap-2">
//                             Learn More
